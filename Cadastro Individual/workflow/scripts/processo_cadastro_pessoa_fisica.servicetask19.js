	 ...
	 try{
         ...
         */
         ...
         var data = {
             ...
             endpoint : '/dts/datasul-rest/resources/prg/esp/v1/esrest0001/implantaFornecedor',
         ...
         hAPI.setTaskComments(getValue("WKUser"), getValue("WKNumProces"),  0, JSON.stringify(data));
         ...
         if(result== null || result.isEmpty())
        	 hAPI.setTaskComments(getValue("WKUser"), getValue("WKNumProces"),  0, "retorno vazio");
         else
        	 hAPI.setTaskComments(getValue("WKUser"), getValue("WKNumProces"),  0, result);
